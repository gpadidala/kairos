...
- All prompts live in `src/pcap/llm/prompts/` as **versioned Jinja2 templates**. The prompt version is captured in `LLMAdvice.prompt_version`.
...
- PCAP tolerates any single provider outage without user-visible impact.
