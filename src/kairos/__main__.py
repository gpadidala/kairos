"""KAIROS CLI entrypoint. Modes: api | scheduler | once."""
...
from kairos.config.settings import get_settings

app = typer.Typer(name="kairos", help="KAIROS — Predictive Capacity & Autoscaling Platform")
