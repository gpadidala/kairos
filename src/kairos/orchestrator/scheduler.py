...
from kairos.config.settings import SchedulerSettings
from kairos.orchestrator.pipeline import Pipeline
...
class PipelineScheduler:
    ...
    def start(self) -> None:
        ...
        self._scheduler.add_job(self._fire, trigger, id="kairos-pipeline", replace_existing=True)
