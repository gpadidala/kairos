...
from pcap.config.settings import GitHubSettings
...
from pcap.observability.metrics import EXTERNAL_CALL_DURATION, PRS_CREATED_TOTAL
        ...
        try:
            ...
            for candidate in ("deployment.yaml", "values.yaml", "statefulset.yaml"):
                ...
                await self._gh.put_file(
                    ...
                    new_content,
                    branch=branch,
                    message=f"PCAP: {decision.action.value} for "
